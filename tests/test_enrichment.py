"""
Automated Pytest for timi-nstemi-risk-score Enrichment Modules.
"""
import sys
...
from enrichment import (
    CardiacBiomarkerTrendingTroponinDeltaBnpTrajectoriesEngine,
...
def test_enrichment_suite_execution():
    suite = TiminstemiriskscoreEnrichmentSuite()
